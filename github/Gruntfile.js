...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy:{
      ...
      build:{
        //The line bellow can be changed accordding to the project
        src:['**','!node_modules/**','!**/Gruntfile.js','!**/package.json','!less/**','!js/jsdoc.js','!images/psd/**','!EbookFocus/**',"!docs/**","!LEVANTAMENTO DE DADOS/**",'!relatorio/**'],
        dest:'dist',
        expand:true
      },
      endbuild:{
      ...
      github:{
        src:['**','!node_modules/**','!EbookFocus/**','!dist/**','!relatorio/**'],
        dest:'EbookFocus/github',
        expand:true
      }
    },
    watch: {
    ...
    uglify: {
       options: {
          ...
          my_target : {
              files : {
                  'dist/js/home.js' : ['dist/js/home.js'],
                  'dist/js/login.js' : ['dist/js/login.js']
              }
          }
      }
  });
